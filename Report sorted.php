...
<div id=dataline">
<div id="Emp"><?php echo $list['employee'] ?><br></div>
<div id="Email"><?php echo $list['email'] ?></div>
<div id="Date"><?php echo $list['date'] ?></div>
<div id="Attempts"><?php echo $list['attempts'] ?></div>
<div id="OldMan"><?php echo $list['formerMan'] ?></div>
<div id="NewMan"><?php echo $list['supervisor'] ?></div>
<div id="ManEmail"><?php echo $list['manEmail'] ?></div>
</div>
<div id="spacer">&nbsp;</div>
