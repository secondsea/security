...
//echo $result;
	...
	$InsQuery="INSERT INTO [APACS Sandbox].[dbo].[00securitytestTEMP]   ([logon] ,[name],[email] ,[testdate]  ,[attempts]  ,[supervisor]  ,[supervisor email] ,[suplogon])
     VALUES ('".$shortusername ."','". $row['name'] . "','" . $email . "','" .$formattedDate ."',".$row['attempts']. ",'" .  $manager ."','" . $Manemail ."','" .$Mansam ."')";
